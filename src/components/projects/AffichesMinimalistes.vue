...
<template>
    <div class="grid grid-cols-2 grid-rows-1 gap-10 w-3/5">
        <img
            v-for="i in 2"
            :key="i"
            :src="`/src/assets/affiches-minimalistes/${i}.jpg`"
    ...
    <div class="grid grid-cols-2 grid-rows-2 gap-10 w-3/5">
        <img
            v-for="i in 4"
            :key="i"
            :src="`/src/assets/affiches-minimalistes/${i + 2}.jpg`"
            class="w-auto h-auto object-cover"
        />
    </div>
    ...
    >
        <img
            v-for="i in 6"
            :key="i"
            :src="`/src/assets/affiches-minimalistes/ideas/${i}.jpg`"
            class="w-auto h-auto object-cover"
        />
    </div>
</template>
